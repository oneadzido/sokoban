...
- **Light & dark theme** — follows the system setting, or choose your own
- **Three-state theme button** — System, Light, or Dark, cycled with a single tap
...
- **Theme**: DayNight with a runtime three-state switch (System / Light / Dark)
